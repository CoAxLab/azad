...
wythoff_eval63a:
	parallel -j 20 -v \
		--nice 19 \
		"run_azad.py evaluate_dqn3 $(DATA_PATH)/wythoff/exp63/run_DQN_{2}_{1}.pytorch --game=Wythoff15x15 --num_episodes=1e2 --opponent=random --debug=False --save=$(DATA_PATH)/wythoff/exp63/eval_{2}_random_{1} --monitor='('episode', 'total_reward', 'score')' --network=DQN_optuna --return_none=True" ::: {2..22} ::: DQN_hot1 DQN_hot1 DQN_hot2 DQN_hot3 DQN_hot4 DQN_hot5 DQN_conv2 DQN_conv3
